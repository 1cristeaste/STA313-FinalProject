...
By far, the top producer of plastic waste that ends up in the ocean is the Philippines, producing 356,371 tons. This is almost three times the amount of the second highest producer, India. About 10 countries produce the bulk of the world’s plastic waste in oceans, most of which are in Asia. Only two of these countries are in the top ten for plastic waste production per capita: the Philippines and Malaysia. Most of the countries that have the highest waste per capita are tiny, developing countries such as Suriname, Saint Lucia, and Grenada, and have negligible total waste. As a result, a natural supposition is that these countries are in the most need of a waste emission and production intervention. However, this fails to account for plastic waste that is imported by these countries. The following visualizations will attempt to investigate where these plastic emissions are actually coming from. 
...
Based on our findings, we determined that although the majority of ocean plastic comes from developing nations particularly in southeast Asia, it does not depict an accurate picture as to who are ultimately responsible for the ever-increasing ocean plastics. We found that North American and European countries tend to export the majority of their emissions to Asian countries as opposed to self-disposal. Similarly, emissions from countries such as Malaysia and the Philippines tend to originate from foreign nations who export their waste to willing nations in exchange for economic gain. Fortunately with the use of modern technology, high-emission nations may implement more efficient systems and emulate waste management strategies from exemplary nations to reduce mismanaged waste.
